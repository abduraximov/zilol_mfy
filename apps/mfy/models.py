...
class WorkerInfo(TimeStampedModel):
    ...
    photo = models.ImageField(_("Photo"), upload_to="workers_photo", null=True, blank=True)
    about = models.TextField(_("About"), null=True, blank=True)
    phone_numbers = models.CharField(_("Phone numbers"), max_length=512, null=True, blank=True)
    work_times = models.CharField(_("Working times"), max_length=512, null=True, blank=True)
...
class VillageBusinnesmen(TimeStampedModel):
    ...
    phone_number = models.CharField(_("Phone number"), max_length=512, null=True, blank=True)
    certificate_photo = models.ImageField(_("Certificate photo"), upload_to="certificate_photo")
...
class VillageBusinnesmenProduct(TimeStampedModel):
    ...
    photo = models.ImageField(_("Photo"), upload_to="product_photo", null=True, blank=True)
...
class JobSeeker(TimeStampedModel):
    ...
    specialist = models.CharField(_("Specialist"), max_length=512, null=True, blank=True)
    phone_number = models.CharField(_("Phone number"), max_length=512, null=True, blank=True)
