...
from apps.mfy.api_endpoints import (
    village_center,
    village_letter,
    village_inventor,
    village_businnesmen,
...
urlpatterns = [
    path(
        "VillageCenter/",
        village_center.VillageCenterAPIView.as_view(),
        name="VillageCenter",
    ),
    path(
        "WorkerInfoList/",
        village_center.WorkerInfoListAPIView.as_view(),
        name="WorkerInfoList",
    ),
    path("StreetList/", village_letter.StreetListAPIView.as_view(), name="StreetList"),
    path(
        "VillageLetter/",
        village_letter.VillageLetterAPIView.as_view(),
        name="VillageLetter",
    ),
    path(
        "VillageLetterList/",
        village_letter.VillageLetterListAPIView.as_view(),
        name="VillageLetterList",
    ),
    path(
    ...
    path(
        "VillageInventor/",
        village_inventor.VillageInventorAPIView.as_view(),
